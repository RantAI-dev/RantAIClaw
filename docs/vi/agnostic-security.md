...
|---------|-----------|--------------|--------|
| **RantaiClaw cơ bản** | 3.4MB | <5MB | ✅ Hiện tại |
...
| Phần cứng | RAM | RantaiClaw (cơ bản) | RantaiClaw (full security) | Trạng thái |
|----------|-----|-----------------|--------------------------|--------|
...
**Ngay cả với full security, RantaiClaw chỉ dùng <5% RAM trên board $10.**

---

## 5. Tính hoán đổi: mọi thứ vẫn pluggable

### Cam kết chính của RantaiClaw: hoán đổi bất kỳ thứ gì
