...
> Companion to `docs/project/archive/cross-surface-agent-architecture.md` (the *current-state*
...
See `docs/project/archive/cross-surface-agent-architecture.md` for the full file:line map.
