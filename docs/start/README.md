...
3. Find commands by tasks: [../reference/commands.md](../reference/commands.md)

## Choose Your Path

| Scenario | Command |
|----------|---------|
| I have an API key, want fastest setup | `rantaiclaw onboard --api-key sk-... --provider openrouter` |
| I want guided prompts | `rantaiclaw onboard --interactive` |
| Config exists, just fix channels | `rantaiclaw onboard --channels-only` |
| Config exists, I intentionally want full overwrite | `rantaiclaw onboard --force` |
| Using subscription auth | See [Subscription Auth](../../README.md#subscription-auth-openai-codex--claude-code) |

## Onboarding and Validation

- Quick onboarding: `rantaiclaw onboard --api-key "sk-..." --provider openrouter`
- Interactive onboarding: `rantaiclaw onboard --interactive`
...
- Validate environment: `rantaiclaw status` + `rantaiclaw doctor`
