...
This playbook is the operational companion to [`docs/contributing/pr-workflow.md`](pr-workflow.md).
...
- If identity-like wording exists, it uses RantaiClaw/project-native roles (not personal or real-world identities).
