# RantaiClaw PR Workflow (High-Volume Collaboration)

This document defines how RantaiClaw handles high PR volume while maintaining:
...
- [`docs/contributing/ci-map.md`](ci-map.md) for per-workflow ownership, triggers, and triage flow.
- [`docs/contributing/reviewer-playbook.md`](reviewer-playbook.md) for day-to-day reviewer execution.
...
- [docs/contributing/ci-map.md](ci-map.md)
...
- [docs/contributing/reviewer-playbook.md](reviewer-playbook.md)
...
- If identity-like wording appears in tests/examples, it is normalized to RantaiClaw/project-native labels.
...
- Confirm any required identity-like wording uses RantaiClaw/project-native terminology.
