"""
Discord bot integration for RantaiClaw.
"""
...
class DiscordBot:
    """
    Discord bot powered by RantaiClaw agent with LangGraph tool calling.
    ...
    def __init__(
        ...
        if not DISCORD_AVAILABLE:
            raise ImportError(
                ...
                "Install with: pip install rantaiclaw-tools[discord]"
            )
    ...
    def _setup_events(self):
        @self.client.event
        async def on_ready():
            print(f"RantaiClaw Discord Bot ready: {self.client.user}")
