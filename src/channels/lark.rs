...
impl Channel for LarkChannel {
    ...
    // Lark has no bot-drivable typing indicator: `start_typing` and
    // `stop_typing` deliberately fall through to the trait default, and the
    // `every_tier_channel_shows_and_clears_a_working_signal` guard asserts
    // they remain absent here.
