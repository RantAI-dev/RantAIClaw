...
// in `~/.rantaiclaw/.secret_key` with restrictive file permissions (0600). The
...
pub struct SecretStore {
    /// Path to the key file (`~/.rantaiclaw/.secret_key`)
    key_path: PathBuf,
...
impl SecretStore {
    ...
    pub fn new(rantaiclaw_dir: &Path, enabled: bool) -> Self {
        Self {
