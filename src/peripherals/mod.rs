...
/// Handle `rantaiclaw peripheral` subcommands.
    ...
    match cmd {
        crate::PeripheralCommands::List => {
            ...
            if boards.is_empty() {
                ...
                println!();
                println!("Add one with: rantaiclaw peripheral add <board> <path>");
                println!("  Example: rantaiclaw peripheral add nucleo-f401re /dev/ttyACM0");
                println!();
