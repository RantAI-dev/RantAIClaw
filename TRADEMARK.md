# RantaiClaw Trademark Policy

**Effective date:** February 2026  
**Maintained by:** RantaiClaw Labs

---

## Our Trademarks

The following are trademarks of RantaiClaw Labs:

- **RantaiClaw** (word mark)
- **rantaiclaw-labs** (organization name)
- The RantaiClaw logo and associated visual identity

These marks identify the official RantaiClaw project and distinguish it from
...
The **only** official RantaiClaw repository is:

> https://github.com/rantaiclaw-labs/rantaiclaw

Any other repository, organization, domain, or product claiming to be
"RantaiClaw" or implying affiliation with RantaiClaw Labs is unauthorized and
may constitute trademark infringement.

**Known unauthorized forks:**
- `openagen/rantaiclaw` — not affiliated with RantaiClaw Labs

If you encounter an unauthorized use, please report it by opening an issue
at https://github.com/rantaiclaw-labs/rantaiclaw/issues.

---

## Permitted Uses

You **may** use the RantaiClaw name and marks in the following ways without
prior written permission:

1. **Attribution** — stating that your software is based on or derived from
   RantaiClaw, provided it is clear your project is not the official RantaiClaw.

2. **Descriptive reference** — referring to RantaiClaw in documentation,
...
4. **Fork identification** — identifying your fork as "a fork of RantaiClaw"
...
You **may not** use the RantaiClaw name or marks in ways that:

1. **Imply official endorsement** — suggest your project, product, or
   organization is officially affiliated with or endorsed by RantaiClaw Labs.

2. **Cause brand confusion** — use "RantaiClaw" as the primary name of a
...
3. **Impersonate the project** — create repositories, domains, packages,
   or accounts that could be mistaken for the official RantaiClaw project.

4. **Misrepresent origin** — remove or obscure attribution to RantaiClaw Labs
   while distributing the software or derivatives.

5. **Commercial trademark use** — use the marks in commercial products,
   services, or marketing without prior written permission from RantaiClaw Labs.
...
you fork RantaiClaw, you must:

- Clearly state your project is a fork of RantaiClaw
- Link back to the official repository
- Not use "RantaiClaw" as the primary name of your fork
...
Contributors to the official RantaiClaw repository are protected under the
...
If you believe someone is infringing RantaiClaw trademarks:

1. Open an issue at https://github.com/rantaiclaw-labs/rantaiclaw/issues
...
RantaiClaw Labs reserves the right to update this policy at any time. Changes
...
this policy governs use of the RantaiClaw name and brand.*
