# RantaiClaw ESP32 UI Firmware

Slint-based graphical UI firmware scaffold for RantaiClaw edge scenarios on ESP32.
...
```bash
cd firmware/rantaiclaw-esp32-ui
cargo build --release
...
3. Connect UI state with RantaiClaw edge/runtime messaging
...
- [RantaiClaw Hardware Design](../../docs/hardware-peripherals-design.md)
