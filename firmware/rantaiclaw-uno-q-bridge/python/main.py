# RantaiClaw Bridge — socket server for full MCU peripheral control
...
def main():
    ...
    server.bind(("0.0.0.0", RANTAICLAW_PORT))
    server.listen(5)
    server.settimeout(1.0)
    print(f"[RantaiClaw Bridge] Listening on 0.0.0.0:{RANTAICLAW_PORT}", flush=True)
