# RantaiClaw Contributor License Agreement (CLA)
...
property rights granted by contributors to RantaiClaw Labs. This agreement
protects both contributors and users of the RantaiClaw project.

By submitting a contribution (pull request, patch, issue with code, or any
other form of code submission) to the RantaiClaw repository, you agree to the
terms of this CLA.
...
- **"Contribution"** means any original work of authorship, including any
  modifications or additions to existing work, submitted to RantaiClaw Labs
  for inclusion in the RantaiClaw project.

- **"You"** means the individual or legal entity submitting a Contribution.

- **"RantaiClaw Labs"** means the maintainers and organization responsible
  for the RantaiClaw project at https://github.com/rantaiclaw-labs/rantaiclaw.

---

## 2. Grant of Copyright License

You grant RantaiClaw Labs and recipients of software distributed by RantaiClaw
...
the RantaiClaw project.

**This protects you:** if a third party files a patent claim against
RantaiClaw that covers your Contribution, your patent license to the project
is not revoked.
...
This CLA does **not** transfer ownership of your Contribution to RantaiClaw
...
3. If your employer has rights to intellectual property you create, you
   ...
   has signed a corporate CLA with RantaiClaw Labs.

---

## 6. No Trademark Rights

This CLA does not grant you any rights to use the RantaiClaw name,
...
RantaiClaw Labs will maintain attribution to contributors in the repository
...
All Contributions accepted into the RantaiClaw project are licensed under
both:
...
By opening a pull request or submitting a patch to the RantaiClaw repository,
...
https://github.com/rantaiclaw-labs/rantaiclaw/issues

---

*This CLA is based on the Apache Individual Contributor License Agreement
v2.0, adapted for the RantaiClaw dual-license model.*
