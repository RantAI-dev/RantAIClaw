...
```bash
# Check config
cat ~/.rantaiclaw/config.toml | grep -A 5 telegram
...
| Health check | <5s | `time rantaiclaw channel doctor` |
...
5. **Monitor logs** for any issues:
   ...
   rantaiclaw daemon
   # or
   RUST_LOG=info rantaiclaw channel start
   ```
...
- Issues: https://github.com/theonlyhennygod/rantaiclaw/issues
- Docs: `./TESTING_TELEGRAM.md`
- Help: `rantaiclaw --help`
