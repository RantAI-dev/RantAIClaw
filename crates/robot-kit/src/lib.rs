...
//!
//! A standalone robotics toolkit that integrates with RantaiClaw for AI-powered robots.
//!
//! ## Features
//!
...
//! ```text
//! ┌─────────────────────────────────────────────────────────┐
//! │  RantaiClaw AI Brain (or any controller)                  │
...
//!
//! ```rust,ignore
//! use rantaiclaw_robot_kit::{RobotConfig, DriveTool, SafetyMonitor, SafeDrive};
//! use std::sync::Arc;
//!
//! #[tokio::main]
//! async fn main() {
...
//! ## Standalone Usage
//!
//! This crate can be used independently of RantaiClaw. It defines its own
//! `Tool` trait that is compatible with RantaiClaw's but doesn't require it.
//!
//! ## Safety
//!
